...
public class Outline : MonoBehaviour
{
	...
	private void Awake()
	{
		Renderer[] componentsInChildren = GetComponentsInChildren<MeshRenderer>(includeInactive: true);
		Renderer[] array = componentsInChildren;
		SkinnedMeshRenderer[] componentsInChildren2 = GetComponentsInChildren<SkinnedMeshRenderer>(includeInactive: true);
		renderers = new Renderer[array.Length + componentsInChildren2.Length];
		array.CopyTo(renderers, 0);
		componentsInChildren2.CopyTo(renderers, array.Length);
